...
describe MunicipalitiesController do
  ...
  describe "GET index" do
    it "assigns all municipalities as @municipalities" do
      ...
      assigns(:municipalities).should eq([municipality])
    end
  end
  ...
  describe "GET show" do
    it "assigns the requested municipality as @municipality" do
      ...
      assigns(:municipality).should eq(municipality)
    end
  end
  ...
  describe "GET new" do
    it "assigns a new municipality as @municipality" do
      ...
      assigns(:municipality).should be_a_new(Municipality)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created municipality as @municipality" do
        post :create, {:municipality => valid_attributes}, valid_session
        assigns(:municipality).should be_a(Municipality)
        assigns(:municipality).should be_persisted
      end

      it "redirects to the created municipality" do
        post :create, {:municipality => valid_attributes}, valid_session
        response.should redirect_to(Municipality.last)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved municipality as @municipality" do
        ...
        Municipality.any_instance.stub(:save).and_return(false)
        post :create, {:municipality => {}}, valid_session
        assigns(:municipality).should be_a_new(Municipality)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested municipality" do
        municipality = Municipality.create! valid_attributes
        # Assuming there are no other municipalities in the database, this
        # specifies that the Municipality created on the previous line
        # receives the :update_attributes message with whatever params are
        # submitted in the request.
        Municipality.any_instance.should_receive(:update_attributes).with({'these' => 'params'})
        put :update, {:id => municipality.to_param, :municipality => {'these' => 'params'}}, valid_session
      end
      ...
      it "redirects to the municipality" do
        municipality = Municipality.create! valid_attributes
        put :update, {:id => municipality.to_param, :municipality => valid_attributes}, valid_session
        response.should redirect_to(municipality)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns the municipality as @municipality" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Municipality.any_instance.stub(:save).and_return(false)
        put :update, {:id => municipality.to_param, :municipality => {}}, valid_session
        assigns(:municipality).should eq(municipality)
      end
  ...
  describe "DELETE destroy" do
    ...
    it "redirects to the municipalities list" do
      municipality = Municipality.create! valid_attributes
      delete :destroy, {:id => municipality.to_param}, valid_session
      response.should redirect_to(municipalities_url)
    end
  end
